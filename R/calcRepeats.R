...
#' Calculate Number of SLIDS
#'
#' Function calculates the number of SLIDS experiencing repeat interruptions
#'
...
#' Functions to Visualise the results from calcNSLIDS
#'
#' @param N integer
#' @param spatYear integer
#' @param df dataframe
#'
...
G2analysis <- function(N, spatYear, df) {
  ...
  p <- ggplot2::ggplot(data = long_tab[long_tab$Year >= 2000, ], ggplot2::aes(x = Year, y = log10(value), color = SLIDS)) +
    ggplot2::geom_line() +
  ...
  # Histogram PLots
  hp1 <- ggplot2::ggplot(data = int, ggplot2::aes(int$Class.Structure)) +
    ggplot2::geom_histogram(stat = "count") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, hjust = 1)) +
    ggplot2::ggtitle(paste0("Number of Interuptions greater than ", N)) +
    ggplot2::labs(y = "", x = "Work Order Type") +
    ggplot2::scale_x_discrete(drop = TRUE)
  hp2 <- ggplot2::ggplot(data = int, ggplot2::aes(int$Pipe.Material)) +
    ggplot2::geom_histogram(stat = "count") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, hjust = 1)) +
    ggplot2::ggtitle(paste0("Number of Interuptions greater than ", N)) +
    ggplot2::labs(y = "", x = "Pipe Material")
  # ggplot(data= int, aes(int$I.D)) + geom_histogram(stat="count")+ ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, hjust =1)) + ggtitle(paste0("Number of Interuptions greater than ",N))
  hp3 <- ggplot2::ggplot(data = int, ggplot2::aes(lubridate::year(as.Date(int$Install.Date)))) +
    ggplot2::geom_histogram(stat = "count") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1)) +
    ggplot2::ggtitle(paste0("Number of Interuptions greater than ", N)) +
    ggplot2::labs(y = "", x = "Year")
  hp4 <- ggplot2::ggplot(data = int, ggplot2::aes(int$Class.Structure.1)) +
    ggplot2::geom_histogram(stat = "count") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, hjust = 1)) +
    ggplot2::ggtitle(paste0("Number of Interuptions greater than ", N)) +
    ggplot2::labs(y = "", x = "Year")

  figure <- ggpubr::ggarrange(hp1, hp2, hp3, hp4,
    labels = c("A", "B", "C", "D"),
    ncol = 2, nrow = 2
  )

  # Bar Plots, Nslids affected
  p <- ggplot2::ggplot(data = int, ggplot2::aes(x = Class.Structure, y = get(A))) +
    ggplot2::geom_bar(stat = "identity") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, hjust = 1)) +
    ggplot2::labs(y = "Total N SLIDS", x = "") +
    ggplot2::ggtitle(paste0("Total N SLIDS interuption greater than ", N))
  p

  p <- ggplot2::ggplot(data = int, ggplot2::aes(x = Pipe.Material, y = get(A))) +
    ggplot2::geom_bar(stat = "identity") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, hjust = 1)) +
    ggplot2::labs(y = "Total N SLIDS", x = "") +
    ggplot2::ggtitle(paste0("Total N SLIDS interuption greater than ", N))
  ...
  p <- ggplot2::ggplot(data = int, ggplot2::aes(x = lubridate::year(as.Date(int$Install.Date)), y = get(A))) +
    ggplot2::geom_bar(stat = "identity") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90, hjust = 1)) +
    ggplot2::labs(y = "Total N SLIDS", x = "") +
    ggplot2::ggtitle(paste0("Total N SLIDS interuption greater than ", N))
  ...
  combined.df %>%
    ...
    dplyr::group_by(I.D) %>%
    dplyr::summarize_at(ggplot2::vars(NSLIDS_1:NSLIDS_7), sum) %>%
    as.data.frame() %>%
  ...
  # Bar Plots, Nslids affected
  p5 <- ggplot2::ggplot(data = tab5[1:20, ], ggplot2::aes(x = I.D, y = MeanNFailsperL)) +
    ggplot2::geom_bar(stat = "identity") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, hjust = 1)) +
    ggplot2::labs(x = "")
  ...
  p <- ggplot(data = Ndistinct, ggplot2::aes(x = Date, y = NumberSOBs)) +
    ggplot2::geom_line() +
    ggplot2::geom_point() +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1))
  p

  p <- ggplot2::ggplot(data = Ndistinct, ggplot2::aes(x = Date, y = NumberSOBnearmiss)) +
    ggplot2::geom_line() +
    ggplot2::geom_point() +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1))
  p

  p <- ggplot(data = Ndistinct, ggplot2::aes(x = Date, y = ratio)) +
    ggplot2::geom_line() +
    ggplot2::geom_point() +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1))
  p
  ...
  p <- ggplot(data = Ndistinct, ggplot2::aes(x = Date, y = BurstPiperatioG2)) +
    ggplot2::geom_line() +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1))
  p

  p <- ggplot2::ggplot(data = Ndistinct, ggplot2::aes(x = Date, y = BurstPiperatio1and2)) +
    ggplot2::geom_line() +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1))
  p
  ...
  p <- ggplot2::ggplot(data = new.combined.df2, ggplot2::aes(x = time_since_asset_failure)) +
  ...
  p <- ggplot2::ggplot(data = new.combined.df2, ggplot2::aes(x = time_since_SOB_outage)) +
    ggplot2::stat_ecdf(geom = "step")
  p + ggplot2::scale_x_continuous(limits = c(0, 365)) -> p7
  p7
  ...
  p <- ggplot2::ggplot(data = new.combined.df2, ggplot2::aes(x = totalNpershutoffblock)) +
    ggplot2::stat_ecdf(geom = "step")
  p + ggplot2::scale_x_continuous(limits = c(0, 100)) -> p
  p
  ...
  p <- ggplot2::ggplot(data = G2Table[G2Table$Year >= 2000, ], ggplot2::aes(x = Year, y = G2cases)) +
    ggplot2::geom_point() +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1))
  p

  tidyr::gather(G2Table, key, result, -Year) -> G2TableL

  p4 <- ggplot2::ggplot(data = G2TableL[G2TableL$Year >= 2000, ], aes(x = Year, y = result, color = key)) +
    ggplot2::geom_line() +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1))
  p4
  ...
  SSS %>%
    dplyr::mutate(yearmonth = as.Date(zoo::as.yearmon(Reported.Date))) %>%
    dplyr::filter(NumberG2SLIDs > 3) %>%
    dplyr::group_by(yearmonth) %>%
    dplyr::summarize(sum = sum(diff)) -> SSSS

  p <- ggplot2::ggplot() +
    ggplot2::geom_point(data = SSSS, ggplot2::aes(x = yearmonth, y = sum)) +
    #  geom_point(data=SSS, aes(x=Reported.Date, y=N.slids.affected), colour="red") +
    ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 0, hjust = 1))
  p + ggplot2::scale_y_continuous(limits = c(0, 300)) -> p

  p + ggplot2::labs(
    title = "Number of SLIDS impacted by Shut off Block Extensions", subtitle = ggplot2::waiver(), caption = ggplot2::waiver(),
    tag = ggplot2::waiver()
  ) -> p

  p + ggplot2::ylab("Number of additional SLIDS") -> p
  p + ggplot2::xlab("2017") -> padd
  ...
  p <- ggplot2::ggplot(data = SSS, ggplot2::aes(x = diff)) +
    ggplot2::stat_ecdf(geom = "step")
  p + ggplot2::scale_x_continuous(limits = c(-100, 100)) -> p
  p
  ...
  grDevices::png("WOs.png", width = 1200, height = 900)
  ggplot2::ggplot(data = YOYOMA) +
    ggplot2::geom_bar(ggplot2::aes(x = "", y = per, fill = Class.Structure), stat = "identity", width = 1) +
    ggplot2::coord_polar("y", start = 0) +
    ggplot2::theme_void() +
    ggplot2::theme(text = ggplot2::element_text(size = 20)) +
    ggplot2::geom_text(aes(x = 1, y = cumsum(per) - per / 2, label = label), size = 7) -> P
  print(P)
  grDevices::dev.off()

  # Creatw a basic bar
  pie <- ggplot2::ggplot(YOYOMA, ggplot2::aes(x = "", y = n, fill = Class.Structure)) +
    ggplot2::geom_bar(stat = "identity", width = 1)
  # Convert to pie (polar coordinates) and add labels
  pie <- pie + ggplot2::coord_polar("y", start = 0) + ggplot2::geom_text(aes(label = n), position = ggplot2::position_stack(vjust = 0.5))

  # Add color scale (hex colors)
  # pie = pie + scale_fill_manual(values=c("#55DSW0", "#33418A","#55DDE0", "#33658A", "#2F4858", "#F6AE2D", "#F26419", "#999999"))

  # Remove labels and add title
  pie <- pie + ggplot2::labs(x = NULL, y = NULL, fill = NULL, title = "All G2 cases - Work Order Breakdown of SLIDS")

  # Tidy up the theme
  pie <- pie + ggplot2::theme_classic() + ggplot2::theme(
  ...
  grDevices::png("SLIDS.png", width = 1200, height = 900)
  ggplot2::ggplot(data = YOYOMA) +
    ggplot2::geom_bar(aes(x = "", y = per, fill = Class.Structure), stat = "identity", width = 1) +
    ggplot2::coord_polar("y", start = 0) +
    ggplot2::theme_void() +
    ggplot2::theme(text = ggplot2::element_text(size = 20)) +
    ggplot2::geom_text(ggplot2::aes(x = 1, y = cumsum(per) - per / 2, label = label), size = 7) -> P2
  print(P2)
  grDevices::dev.off()
  ...
  for (i in 1:length(listofYears)) {
    ...
    newcombined.df %>%
      ...
      dplyr::filter(NumberG2SLIDs > 0) %>%
      dplyr::group_by(Shutoff.Block) %>%
      dplyr::summarise_at(c("Latitude", "Longitude"), mean, na.rm = TRUE) -> temp0

    newcombined.df %>%
      dplyr::filter(Reported.Date %within% int[[i]]) %>%
      dplyr::filter(NumberG2SLIDs > 0) %>%
      dplyr::group_by(Shutoff.Block) %>%
      dplyr::summarise_at(c("NSLIDS_3", "NSLIDS_4", "NSLIDS_5", "NSLIDS_6", "NSLIDS_7"), sum, na.rm = TRUE) -> temp
    ...
    NdistinctSOBs[[i]] -> df
    df[stats::complete.cases(df), ] -> df
    sp::coordinates(df) <- c("Latitude", "Longitude") # promote to SpatialPointsDataFrame

    grDevices::png(filename = paste0("Outputs/bubbleplot_", i, ".png"))
    sp::bubble(df, "Noutages",
