...
```{r}
import_data(AssetPath=AssetPath,
            WorkOrderPath=WorkOrderPath,
            newWorkOrdersPath=newworkordersPAth,
            HansenPath = HansenPath,
            rainfall=rainfall,
            ClimatePath=ClimateData,
            minTemp=minTemp,
            maxTemp=maxTemp,
            soilData = soilData,
...
saveRDS(importedData, "C:/Users/bgladman/OneDrive/DataProjects/YVW/PackageOutputs/importedData.RDS")
```

```{r}
data_wrangle(importedData) -> CleanedData
saveRDS(CleanedData, "C:/Users/bgladman/OneDrive/DataProjects/YVW/PackageOutputs/CleanedData.RDS")
...
saveRDS(WO_SLIDS, "C:/Users/bgladman/OneDrive/DataProjects/YVW/PackageOutputs/WO_SLIDS.RDS")
...
saveRDS(Asset_WO_List, "C:/Users/bgladman/OneDrive/DataProjects/YVW/PackageOutputs/Asset_WO_List.RDS")
...
# mainDir="C:/Users/bgladman/OneDrive/DataProjects/YVW/PackageOutputs"
# ) -> Arg2018
```
