...
tibble::glimpse(read.csv(AssetPath))
tibble::glimpse(read.csv(WorkOrderPath))
tibble::glimpse(read.csv(newworkordersPAth))
tibble::glimpse(read.csv(newworkordersPAth2))
tibble::glimpse(read.csv(HansenPath))
tibble::glimpse(read.csv(GISdata))
tibble::glimpse(read.csv(SOBSLID))
